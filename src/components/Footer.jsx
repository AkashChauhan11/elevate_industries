        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-cream-white-300 hover:text-warm-yellow-200 transition-colors">
          ...
          <div>
            ...
            <div className="space-y-2 text-cream-white-200">
              <p>568, Senor Metal Chokdi,</p>
              <p>Dared GIDC Phase-2,</p>
              <p>Jamnagar, Gujarat - 361004, India</p>
              <p className="mt-4">
                <span className="font-semibold text-warm-yellow-200">Phone:</span> +91 98248 95049
              </p>
              <p>
                <span className="font-semibold text-warm-yellow-200">Email:</span> elevateind123@gmail.com
              </p>
            </div>
          </div>
        </div>
